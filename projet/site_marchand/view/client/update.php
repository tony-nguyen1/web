...
<form method=\"get\" action=\"index.php\">
    <fieldset>
        ...
        <input type=\"text\" name=\"nom\" id='nomID'> <br> <br>

        <label for=\"prenomID\"> Rentrez votre nom</label>
        <input type=\"text\" name=\"prenom\" id='prenomID'> <br> <br>

        <label for=\"villeID\"> Quelle ville habitez vous?</label>
        <input type=\"text\" name=\"ville\" id='villeID'><br> <br>

        <label for=\"adresseID\">Rentrez votre adresse</label>
        <input type=\"text\" name=\"adresse\" id='adresseID'><br> <br>

        <label for=\"identifiantID\"> Rentrez votre adresse mail </label>
        <input type=\"email\" name=\"identifiant\" id='identifiantID' {$lecture}> <br><br>

        <label for=\"mdpID\"> Rentrez votre mot de passe</label>
        <input type=\"password\" name=\"mdp\" id='mdpID' {$lecture}> <br>

        <label for=\"mdp_confirmID\"> confirmer</label>
        <input type=\"password\" name=\"mdp_confirm\" id='mdp_confirmID' {$lecture}> <br>
